...
export default function RootLayout({ children }) {
	...
	const footer = (
		<footer className="p-4 sm:p-8 grid place-items-center">
			<Link href={"https://github.com/enggar77/broodl"} target="_blank" className="">
				<p className={"text-indigo-500 duration-200 hover:text-indigo-400 transition " + fugaz.className}>
					Created with &nbsp;💛
				</p>
			</Link>
		</footer>
